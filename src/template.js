    ...
    <div class="max-w-8xl mx-auto h-full">
      <div class="flex items-center justify-between h-full px-4 lg:px-8">
        ...
        <div class="flex items-center space-x-4">
          ...
          <a class="hidden lg:inline-flex items-center justify-center h-8 px-4 text-sm font-medium text-white bg-primary-500 rounded-lg shadow-sm hover:bg-primary-600 transition-colors duration-200" href="ttps://github.com/your-repo" target="_blank">
